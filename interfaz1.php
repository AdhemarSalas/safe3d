<?php
  ...
  if($_SESSION['cargo']=='Trabajador' || $_SESSION['cargo']=='Jefe'){
    header("location:index.php");
  }
 ?>
...
<html lang="es" dir="ltr">
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox1" name="printstate2" value="stateP" onchange="javascript:checking('checkbox1','rep1',1)" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox2" name="printstate2" value="stateP" onchange="javascript:checking('checkbox2','rep2','2')" onclick="return ejecutarDIAG()" disabled disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox3" name="printstate2" value="stateP" onchange="javascript:checking('checkbox3','rep3','3')" onclick="return ejecutarDIAG()" disabled disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox4" name="printstate2" value="stateP" onchange="javascript:checking('checkbox4','rep4','4')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox5" name="printstate2" value="stateP" onchange="javascript:checking('checkbox5','rep5','5')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox6" name="printstate2" value="stateP" onchange="javascript:checking('checkbox6','rep6','6')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox7" name="printstate2" value="stateP" onchange="javascript:checking('checkbox7','rep7','7')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox8" name="printstate2" value="stateP" onchange="javascript:checking('checkbox8','rep8','8')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox9" name="printstate2" value="stateP" onchange="javascript:checking('checkbox9','rep9','9')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox10" name="printstate2" value="stateP" onchange="javascript:checking('checkbox10','rep10','10')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox11" name="printstate2" value="stateP" onchange="javascript:checking('checkbox11','rep11','11')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox12" name="printstate2" value="stateP" onchange="javascript:checking('checkbox12','rep12','12')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox13" name="printstate2" value="stateP" onchange="javascript:checking('checkbox13','rep13','13')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox14" name="printstate2" value="stateP" onchange="javascript:checking('checkbox14','rep14','14')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
        ...
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox15" name="printstate2" value="stateP" onchange="javascript:checking('checkbox15','rep15','15')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
  ...
  <div class="popup" id="popup16">
        <div class="Impresoras3D">
          ...
          <div id="bot1">
            ...
            <div id="inf">
              ...
              <div id="B">
                  <input type="checkbox" id="checkbox16" name="printstate2" value="stateP" onchange="javascript:checking('checkbox16','rep16','16')" onclick="return ejecutarDIAG()" disabled>
              </div>
              <div id="C">
                SI
              </div>
    ...
    <form class="interfaz-form" action="validar.php" method="post">
      ...
      <div id="Botones">
        <input id="addUser" type="button" class="Boton" value="Agregar nuevo usuario" onclick="usuariomas()" disabled>
        <input id="removeUser" type="button" class="Boton" value="Quitar usuario" onclick="usuariomenos()" disabled>
        <input id="addPrinter" type="button" class="Boton" value="Agregar impresora" onclick="printmas()" disabled>
        <input id="removePrinter" type="button" class="Boton" value="Quitar impresora" onclick="printmenos()" disabled>
